    ...
    <nav className="bg-[#f8f8d8] px-6 py-4 flex items-center justify-between sticky top-0 z-50 shadow-md">
      ...
      {isOpen && (
        <ul className="absolute top-[72px] left-0 w-full bg-[#f8f8d8] flex flex-col items-center gap-6 py-6 text-black font-bold text-lg shadow-md md:hidden transition-all z-40">
          <li>
            <Link to="/" onClick={() => setIsOpen(false)} className="hover:text-green-600 transition">INICIO</Link>
          </li>
          <li>
            <Link to="/planes" onClick={() => setIsOpen(false)} className="hover:text-green-600 transition">PLANES</Link>
          </li>
          <li>
            <Link to="/nosotros" onClick={() => setIsOpen(false)} className="hover:text-green-600 transition">NOSOTROS</Link>
          </li>
          <li>
